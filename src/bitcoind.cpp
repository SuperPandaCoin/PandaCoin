...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/pandacoin.conf are parsed in qt/bitcoin.cpp's main()
        ...
        {
            // First part of help message is specific to pandacoind / RPC client
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "pandacoin:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect pandacoind signal handlers
    noui_connect();
